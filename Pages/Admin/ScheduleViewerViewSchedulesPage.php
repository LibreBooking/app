...
class ScheduleViewerViewSchedulesPage extends ManageSchedulesPage
{
    public function __construct()
    {
        ...
        $this->_presenter = new ManageSchedulesPresenter(
            $this,
            new ScheduleViewerViewSchedulesService(
...
class ScheduleViewerViewSchedulesService extends ManageScheduleService
{
    /**
