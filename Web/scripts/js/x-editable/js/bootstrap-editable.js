    ...
    $.extend(Checklist.prototype, {
        renderList: function () {
            ...
            for (var i = 0; i < this.sourceData.length; i++) {
                ...
                $label[this.options.escape ? 'text' : 'html'](' ' + this.sourceData[i].text);
                var $checkbox = $('<input>', {
                    type: 'checkbox',
                ...
                $('<div class="form-check">').append($label).append($checkbox).appendTo(this.$tpl);
            }
...
(function ($) {
    ...
    Combodate.prototype = {
        ...
        init: function () {
            ...
            this.$widget = $('<span class="combodate d-flex align-items-center gap-1"></span>').html(this.getTemplate());
        ...
        */
        getTemplate: function () {
            ...
            $.each(this.map, function (k, v) {
                ...
                tpl = tpl.replace('{' + token + '}', '<select class="form-select form-select-sm ' + k + ' ' + customClass + '"' +
