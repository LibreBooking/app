...
<p>Um Booked Scheduler verwenden zu können, ist eine Registrierung erforderlich. (Wenn der Administrator die Registrierung aktiviert hat).
...
<p>
Das löschen einer Reservierung entfernt sie komplett aus dem Zeitplan. Sie wird in Booked Scheduler nirgends mehr sichtbar sein.
</p>
...
Fügen Sie die URL ein, die Sie unter "Kalender Abonnieren" in Booked Scheduler gedruckt finden.
</p>
