...
<div id="help">
	...
	<div id="help-configuration">
		...
		<p class="setting"><span>$conf['settings']['reservation']['checkin.minutes.prior']</span>The amount of time before a reservation starts that someone can
			check into it. Default is 5 minutes.</p>

		<p class="setting"><span>$conf['settings']['reservation']['default.start.reminder']</span>The default start reminder for reservations. The format is #
			interval. For example, 10 minutes, 1 hours, 4 days. Default is empty.</p>

		<p class="setting"><span>$conf['settings']['reservation']['default.end.reminder']</span>The default end reminder for reservations. The format is #
			interval. For example, 10 minutes, 1 hours, 4 days. Default is empty.</p>
		...
		{literal}
			<p class="setting"><span>$conf['settings']['reservation.labels']['reservation.popup']</span>The format of
				...
				{attributes} {pending}. Reservation custom attributes can be individually added using att with the attribute id. For example {att1}.
