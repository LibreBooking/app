...
<div class="row">
    ...
    <div id="help" class="col-xs-12 col-sm-9">
        ...
        <div id="help-getting-started">
            ...
            <p>{$AppTitle} lets you manage resources of any type. Conference rooms, tennis courts, rental cars, these
                are
                all examples of resources. Schedules are where available time slots are defined. All resources must be
        ...
        <div id="help-resources">
            ...
            <p>You can set a resource image which will be displayed when viewing resource details from the reservation
                page.
                This
        ...
        <div id="help-groups">
            ...
            <p><em>Application Administrator:</em> Users that belong to a group that is given the Application
                ...
                role are
                open to
                full administrative privileges. This role has nearly zero restrictions on what resources can be booked.
                It
                can
            ...
            <p><em>Resource Administrator:</em> Users that belong to a group that is given the Resource Administrators
                role
                have the
                same capabilities as Application
                Administrators for any resource which the group is assigned to. They can change resource details, black
                out
                times, manage and approve
                reservations.</p>

            <p><em>Schedule Administrator:</em> Users that belong to a group that is given the Schedule Administrators
                role
                have the
                same capabilities as Application
        ...
        <div id="help-attributes">
            ...
            <p>Attributes can be configured as single line text box, a multi-line text box, a select list (drop down),
                or a
                checkbox. All attributes can be
                configured to be required. Textbox attributes allow an optional validation expression to be set. This
                value
        ...
        <div id="help-payments">
            ...
            <p>Within the Payments management screen, click the Payment Gateways tab and enable Stripe. Booked
                integrates
                with Stripe
                using <a href="https://stripe.com/checkout">Stripe Checkout</a>, which requires use of the Stripe API.
                First
            ...
            <p>Within the Payments management screen, click the Payment Gateways tab and enable PayPal. Booked
                ...
                First create a <a href="https://www.paypal.com/">PayPal</a> account if you do not already have one and
                navigate to <a href="https://developer.paypal.com">PayPal Developer</a>
                In the REST API apps section, create a new app. In the App details section you will have access to both
        ...
        <div id="help-slack-integration">
            ...
            <p>You can begin a Booked reservation request directly from Slack. You will need to <a
                        href="https://api.slack.com/slack-apps#creating_apps" target="_blank">create a Slack App</a> in
                your
            ...
            <p>You can then use <em>/book resource-name</em> from Slack to begin a reservation request, substitutiing
        ...
        <div id="help-configuration">
            ...
            <p class="setting"><span>$conf['settings']['allow.self.registration']</span>If users are allowed to register
                new
            ...
            <p class="setting"><span>$conf['settings']['default.language']</span>Default language for all users. This
                can be
                any
                language in the
            ...
            <p class="setting"><span>$conf['settings']['image.upload.directory']</span>The physical directory to store
                images.
                This directory will need to be writable (755 suggested). This can be the full directory or relative to
                the
            ...
            <p class="setting"><span>$conf['settings']['cache.templates']</span>Whether or not templates are cached. It
                is
            ...
            <p class="setting"><span>$conf['settings']['use.local.jquery']</span>Whether or not a local version of
                jQuery
                files
                should be used. If set to false, the files will be served from the Google CDN. It is recommended to set
                this
                to
            ...
            <p class="setting"><span>$conf['settings']['registration.require.email.activation']</span>Whether or not a
                user
                will be
                required to activate their account by email before logging in.</p>

            <p class="setting"><span>$conf['settings']['registration.auto.subscribe.email']</span>Whether or not users
                will
                be
            ...
            <p class="setting"><span>$conf['settings']['css.extension.file']</span>Full or relative URL to an additional
                CSS
                file to
            ...
            <p class="setting"><span>$conf['settings']['home.url']</span>Where the user will be redirected when the logo
                is
                clicked.
            ...
            <p class="setting"><span>$conf['settings']['default.homepage']</span>The default homepage to use when new
                users
            ...
            <p class="setting"><span>$conf['settings']['privacy']['view.reservations']</span>If non-authenticated users
                can
                view
                reservation details.
                Default is false.</p>

            <p class="setting"><span>$conf['settings']['privacy']['hide.user.details']</span>If non-administrators can
                view
                personal
            ...
            <p class="setting"><span>$conf['settings']['reservation']['start.time.constraint']</span>When reservations
                can
                be
                created or edited.
                ...
                starting
                time of
                the selected slot is in the past. Current means reservations can be created or modified if the ending
                time
                of the
            ...
            <p class="setting"><span>$conf['settings']['reservation']['allow.wait.list']</span>Whether or not
                users can be notified of time slot availability. This requires the wait list job to be running. Default
                is
                false.</p>
            ...
            <p class="setting"><span>$conf['settings']['reservation.notify']['resource.admin.add']</span>Whether or not
                to
                send an
                email to all resource administrators when a reservation is created. Default is false.</p>

            <p class="setting"><span>$conf['settings']['reservation.notify']['resource.admin.update']</span>Whether or
                not
                to send
                an
                email to all resource administrators when a reservation is updated. Default is false.</p>

            <p class="setting"><span>$conf['settings']['reservation.notify']['resource.admin.delete']</span>Whether or
                not
                to send
                an
                email to all resource administrators when a reservation is deleted. Default is false.</p>

            <p class="setting"><span>$conf['settings']['reservation.notify']['application.admin.add']</span>Whether or
                not
                to send
                an
            ...
            <p class="setting"><span>$conf['settings']['reservation.notify']['group.admin.add']</span>Whether or not to
                send
                an
                email to all group administrators when a reservation is created. Default is false.</p>

            <p class="setting"><span>$conf['settings']['reservation.notify']['group.admin.update']</span>Whether or not
                to
                send an
                email to all group administrators when a reservation is updated. Default is false.</p>

            <p class="setting"><span>$conf['settings']['reservation.notify']['group.admin.delete']</span>Whether or not
                to
                send an
            ...
            <p class="setting"><span>$conf['settings']['phpmailer']['smtp.port']</span>SMTP port, if using smtp, usually
                25
            </p>
            ...
            <p class="setting"><span>$conf['settings']['phpmailer']['smtp.auth']</span>SMTP requies authentication, if
                using
                smtp.
                Options are true or false</p>

            <p class="setting"><span>$conf['settings']['phpmailer']['smtp.username']</span>SMTP username, if using smtp
            </p>

            <p class="setting"><span>$conf['settings']['phpmailer']['smtp.password']</span>SMTP password, if using smtp
            </p>

            <p class="setting"><span>$conf['settings']['phpmailer']['sendmail.path']</span>Path to sendmail, if using
                sendmail</p>

            <p class="setting"><span>$conf['settings']['plugins']['Authentication']</span>Name of authentication plugin
                to
                use. For
            ...
            <p class="setting"><span>$conf['settings']['plugins']['Permission']</span>Name of permission plugin to use.
                For
                more on
                plugins, see Plugins below</p>

            <p class="setting"><span>$conf['settings']['plugins']['PreReservation']</span>Name of prereservation plugin
                to
                use. For
                more on plugins, see Plugins below</p>
            ...
            <p class="setting"><span>$conf['settings']['recaptcha']['enabled']</span>If reCAPTCHA should be used instead
                of
                the
            ...
            <p class="setting"><span>$config['settings']['email']['default.from.address']</span>The email address to use
                as
                the 'from' address when sending emails. If emails are bouncing or being marked as spam, set this to an
                email
                address with your domain name. For example, noreply@yourdomain.com. This will not change the 'from' name
                or
                the reply-to address.</p>

            <p class="setting"><span>$config['settings']['email']['default.from.name']</span>The friendly name to use as
                the
            ...
            <p class="setting"><span>$conf['settings']['reservation.labels']['rss.description']</span>The format of what
                to
                display in the
                description field for rss/atom feeds. Available tokens are listed in the Available Label Tokens section.
            </p>
            ...
            <p class="setting"><span>$conf['settings']['reservation.labels']['resource.calendar']</span>The format of
                what
                to display for the
                ...
                section.</p>
            {literal}
                <p class="setting"><span>$conf['settings']['reservation.labels']['reservation.popup']</span>The format
                    of
            ...
            <p class="setting"><span>$conf['settings']['authentication']['allow.facebook.login']</span>If users can log
                in
                to
                {$AppTitle} using Facebook. Default is false.</p>

            <p class="setting"><span>$conf['settings']['authentication']['allow.google.login']</span>If users can log in
                to
            ...
            <p class="setting"><span>$conf['settings']['credits']['enabled']</span>Whether or not credit functionality
                is
            ...
            <p class="setting"><span>$conf['settings']['slack']['token']</span>Slack Verification Token. If this is not
                set,
...
{/literal}
        ...
        <div id="help-active-directory">
            ...
            <p class="setting"><span>$conf['settings']['password']</span>Admin user password to bind with (this is not
                always
                required).</p>

            <p class="setting"><span>$conf['settings']['basedn']</span>The base dn for your domain. This is generally
                the
                same
            ...
            <p class="setting"><span>$conf['settings']['account.suffix']</span>The full account suffix for your domain.
                Example:
        ...
        <div id="help-ldap">
            ...
            <p class="setting"><span>$conf['settings']['starttls']</span>Whether or not to start TLS after connecting
            </p>

            <p class="setting"><span>$conf['settings']['binddn']</span>The distinguished name to bind as (username). If
                you
                don't supply this, an anonymous bind will be
                established.</p>

            <p class="setting"><span>$conf['settings']['bindpw']</span>Password for the binddn. If the credentials are
                wrong,
        ...
        <div id="help-cas">
            ...
            <p class="setting"><span>$conf['settings']['cas.server.uri']</span>The URI the CAS server is responding on.
            </p>

            <p class="setting"><span>$conf['settings']['cas.change.session.id']</span>Whether or not to allow phpCAS to
                change
                the session_id.</p>

            <p class="setting"><span>$conf['settings']['email.suffix']</span>Email suffix to use when storing CAS user
                account.
                ex) Email addresses will be saved to
                {$AppTitle} as username@yourdomain.com</p>

            <p class="setting"><span>$conf['settings']['cas_logout_servers']</span>Comma separated list of servers to
                use
                for
            ...
            <p>When using CAS you should also set <span class="setting">$conf['settings']['logout.url']</span> to your
                CAS
                logout server</p>
        ...
        <div id="help-saml">
            ...
            <p>{$AppTitle} relies on <a href="https://simplesamlphp.org/" target="_blank">SimpleSAMLphp</a> to support SAML authentication.</p>
        ...
        <div id="help-wordpress">
            ...
            <p class="setting"><span>$conf['settings']['database.auth.when.wp.user.not.found']</span>If WordPress auth
                fails,
