...
class sv_sv extends en_us
{
    ...
    protected function _LoadStrings()
    {
        ...
        $strings['InsufficientPermissionsError'] = 'Du har inte behörighet att komma åt denna resurs';
        $strings['MissingReservationResourceError'] = 'En resurs har inte valts';
        ...
        $strings['RepeatEveryPrompt'] = 'Alla';
        ...
        $strings['AllResources'] = 'Alla resurser';
        ...
        $strings['ResourceCapacity'] = 'Denna resurs har en kapasitet av %s människor';
        $strings['ResourceCapacityNone'] = 'Denna resurs är obegränsad';
        $strings['AddNewResource'] = 'Lägg till ny resurs';
        ...
        $strings['Search'] = 'Sök';
        $strings['ResourcePermissions'] = 'Tillstånd av resurs';
        ...
        $strings['AddQuota'] = 'Lägg till fråga';
        ...
        $strings['AddBlackout'] = 'Lägg till avstängning';
        $strings['AllResourcesOn'] = 'Alla tillgångar är på';
        $strings['Reason'] = 'Orsak';
        $strings['BlackoutShowMe'] = 'Visa bokningar i konflikt';
        $strings['BlackoutDeleteConflicts'] = 'Ta bort bokningar som är i konflikt';
        $strings['Filter'] = 'Filter';
        $strings['Between'] = 'Mellan';
        $strings['CreatedBy'] = 'Skapad av';
        $strings['BlackoutCreated'] = 'Mörkläggning Skapad!';
        $strings['BlackoutNotCreated'] = 'Mörkläggning kunde inte skapas!';
        $strings['BlackoutConflicts'] = 'Det finns mörklagd tid i konflikt';
        ...
        $strings['DeleteGroupWarning'] = 'Tar du bort denna grupp kommer alla resurstillhörigheter att raderas . Användare i denna grupp kan förlora tillgången                 till resurserna.';
        ...
        $strings['AllQuotas'] = 'Alla frågor';
        $strings['QuotaReminder'] = 'Komihåg: tillämpade frågor bygger på schemat \ s tidszon.';
        ...
        $strings['DeleteResourceWarning'] = 'Tar du bort denna resurs kommer all tillhörande data tas bort, inklusive';
        ...
        $strings['AddUser'] = 'Lägg till användare';
        $strings['UserPermissionInfo'] = 'Faktisk åtkomst till resursen kan variera beroende på användarens roll, grupptillhörighet eller externa                   behörighetsinställningar';
        ...
        $strings['MoveResourcesAndReservations'] = 'Flytta resurser och bokningar till';
        ...
        $strings['NoResourceAdministratorLabel'] = '(Ingen resursadministratör)';
        $strings['WhoCanManageThisResource'] = 'Vem kan hantera denna resurs?';
        $strings['ResourceAdministrator'] = 'Resurs administratör';
        ...
        $strings['NoResourcePermission'] = 'Du har inte behörighet att komma åt ett eller flera av de begärda resurserna';
        ...
        $strings['ManageResources'] = 'Resurser';
        $strings['ManageAccessories'] = 'Tillval';
        $strings['ManageUsers'] = 'Användare';
        $strings['ManageGroups'] = 'Grupper';
        $strings['ManageQuotas'] = 'Frågor';
        ...
        $strings['MyCalendar'] = 'Min kalender';
        $strings['ResourceCalendar'] = 'Resurskalender';
        ...
        $strings['ResourceReservations'] = 'Resursbokning';
        $strings['Customization'] = 'Anpassningar';
        $strings['Attributes'] = 'Tillval';
