...
class ja_jp extends en_us
{
    ...
    protected function _LoadStrings()
    {
        ...
        $strings['AllNoUpcomingReservations'] = '近日中の予約はありません';
        ...
        $strings['LayoutDescription'] = '先頭を %s にして %s 日間を表示';
        ...
        $strings['ResourceMinLength'] = '予約は %s 以上必要';
        $strings['ResourceMinLengthNone'] = '予約の最短時間は未設定';
        $strings['ResourceMaxLength'] = '%s を超える予約は不可';
        $strings['ResourceMaxLengthNone'] = '予約の最長時間は未設定';
        $strings['ResourceRequiresApproval'] = '予約には承認が必要';
        $strings['ResourceRequiresApprovalNone'] = '予約に承認は不要';
        $strings['ResourcePermissionAutoGranted'] = '新規ユーザーも利用可能';
        $strings['ResourcePermissionNotAutoGranted'] = '新規ユーザーは個別に利用許可が必要';
        $strings['ResourceMinNotice'] = '開始時刻よりも %s 以前に予約が必要';
        $strings['ResourceMinNoticeNone'] = '現在時刻まで予約可能';
        ...
        $strings['ResourceNotAllowMultiDay'] = '日をまたいでの予約不可';
        $strings['ResourceCapacity'] = 'このリソースは %s 人まで利用可能';
        $strings['ResourceCapacityNone'] = 'このリソースに人数制限なし';
        ...
        $strings['AllQuotas'] = '全ての使用制限';
        $strings['QuotaReminder'] = '注意: 使用制限はそれぞれのスケジュールのタイムゾーンによって計算されます。';
