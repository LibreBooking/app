...
class ja_jp extends en_gb
{
	...
	protected function _LoadStrings()
	{
        ...
        $strings['ResourceMinNoticeUpdate'] = '予約は開始時刻の %s 前まで変更できます';
        $strings['ResourceMinNoticeNoneUpdate'] = '現時刻でも予約を変更できます';
        $strings['ResourceMinNoticeDelete'] = '予約は開始時刻の %s 前まで削除できます';
        $strings['ResourceMinNoticeNoneDelete'] = '現時刻でも予約を削除できます';
        ...
        $strings['AnnouncementEmailNotice'] = 'このお知らせはメールで送信されます';
        $strings['Day'] = '日';
        ...
        $strings['OnlyIcs'] = 'icsファイルのみアップロードできます';
...
//        $strings['ResourceMinNoticeUpdateCsv'] = 'Reservation Update Minimum Notice';
        $strings['ResourceMinNoticeDeleteCsv'] = '予約を削除した際に最小限の通知';
...
//        $strings['ResourceMaxNoticeCsv'] = 'Reservation Maximum End';
        ...
        $strings['Reject'] = '却下';
        $strings['CheckingAvailability'] = '利用可能か確認';
        ...
        $strings['ReservationDeletedLog'] = '予約が削除されました。参照番号 %s ';
        ...
        $strings['ReservationDeleteAdminSubject'] = '通知：予約削除';
...
//        $strings['InviteUserSubject'] = '%s has invited you to join %s';
        ...
        $strings['ReservationDeletedSubjectWithResource'] = '%s の予約が削除されました';
        ...
        $strings['ReservationDeleteAdminSubjectWithResource'] = '通知：%sの予約が削除されました';
        ...
        $strings['ParticipantDeletedSubjectWithResource'] = '%s は %s の予約を削除しました';
