...
class ja_jp extends Language
{
    ...
    protected function _LoadStrings()
    {
        ...
        $strings['ResourcePermissionAutoGranted'] = '自動的に許可されます';
        $strings['ResourcePermissionNotAutoGranted'] = '自動的には許可されません';
        ...
        $strings['Created'] = '作成済み';
        $strings['LastModified'] = '最終変更';
        ...
        $strings['Reason'] = '理由';
        $strings['BlackoutShowMe'] = 'かち合う予約を表示する';
        $strings['BlackoutDeleteConflicts'] = 'かち合う予約は削除する';
        ...
        $strings['BlackoutConflicts'] = '利用不能時間がかち合っています';
        $strings['ReservationConflicts'] = '予約とかち合っています';
        ...
        $strings['ConflictingReservationDates'] = '次の日時で予約がかち合っています:';
