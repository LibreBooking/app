...
class AccessoryDto
{
	...
	/**
	 * @var CreditApplicability|int|null
	 */
	...
	{
		return !empty($this->CreditCount) || !empty($this->PeakCreditCount);
	}
	 ...
	 * @param int|null $creditCount
	 * @param int|null $peakCreditCount
	 * @param int|CreditApplicability|null $creditApplicability
	 */
								...
								$creditApplicability)
	{
		...
		$this->CreditCount = empty($creditCount) ? 0 : $creditCount;
		$this->PeakCreditCount = empty($peakCreditCount) ? 0 : $peakCreditCount;
		$this->CreditApplicability = $creditApplicability;
	}

	public static function Create($row)
	{
		return new AccessoryDto($row[ColumnNames::ACCESSORY_ID],
