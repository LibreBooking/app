...
class ScheduleReservationListTests extends TestBase
{
	...
	public function setup()
	{
		...
		$this->testDbLayout = $adjustedLayout;
	}
...
//		printf("%s\n", Date::Now()->ToString());
		...
		$list = new ScheduleReservationList($reservations, $this->testDbLayout);
		$slots = $list->BuildSlots($this->date);
		
//		printf("%s\n", Date::Now()->ToString());
		
		$slot1 = new EmptyReservationSlot(new Time(0,0,0, $userTz), new Time(2,0,0, $userTz));
		$slot2 = new EmptyReservationSlot(new Time(2,0,0, $userTz), new Time(2,30,0, $userTz));
		$slot3 = new EmptyReservationSlot(new Time(2,30,0, $userTz), new Time(3,0,0, $userTz));
		$slot4 = new ReservationSlot(new Time(3,0,0, $userTz), new Time(4,30,0, $userTz), 3);
		$slot5 = new EmptyReservationSlot(new Time(4,30,0, $userTz), new Time(5,0,0, $userTz));
		$slot6 = new ReservationSlot(new Time(5,0,0, $userTz), new Time(5,30,0, $userTz), 1);
		$slot7 = new EmptyReservationSlot(new Time(5,30,0, $userTz), new Time(6,0,0, $userTz));
		$slot8 = new EmptyReservationSlot(new Time(6,0,0, $userTz), new Time(6,30,0, $userTz));
		$slot9 = new EmptyReservationSlot(new Time(6,30,0, $userTz), new Time(7,0,0, $userTz));
		$slot10 = new EmptyReservationSlot(new Time(7,0,0, $userTz), new Time(7,30,0, $userTz));
		$slot11 = new EmptyReservationSlot(new Time(7,30,0, $userTz), new Time(8,0,0, $userTz));
		$slot12 = new ReservationSlot(new Time(8,0,0, $userTz), new Time(12,0,0, $userTz), 8);
		$slot13 = new EmptyReservationSlot(new Time(12,0,0, $userTz), new Time(12,30,0, $userTz));
		$slot14 = new EmptyReservationSlot(new Time(12,30,0, $userTz), new Time(13,0,0, $userTz));
		$slot15 = new EmptyReservationSlot(new Time(13,0,0, $userTz), new Time(13,30,0, $userTz));
		$slot16 = new EmptyReservationSlot(new Time(13,30,0, $userTz), new Time(14,0,0, $userTz));
		$slot17 = new EmptyReservationSlot(new Time(14,0,0, $userTz), new Time(14,30,0, $userTz));
		$slot18 = new EmptyReservationSlot(new Time(14,30,0, $userTz), new Time(15,0,0, $userTz));
		$slot19 = new EmptyReservationSlot(new Time(15,0,0, $userTz), new Time(18,0,0, $userTz), 1);
		$slot20 = new EmptyReservationSlot(new Time(18,0,0, $userTz), new Time(0,0,0, $userTz), 1);
