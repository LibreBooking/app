...
class ScheduleRepositoryTests extends TestBase
{
    ...
    public function testCanGetScheduleById()
    {
        ...
        $this->db->SetRows(array($fakeSchedules->GetRow($id, $name, $isDefault, $weekdayStart, $daysVisible, $timezone,
            $layoutId, $allowSubscription, $publicId, null, $start->ToDatabase(), $end->ToDatabase(), $allowConcurrent)));
    ...
    public function testCanUpdateSchedule()
    {
        ...
        $this->assertEquals(new UpdateScheduleCommand($id, $name, $isDefault, $weekdayStart, $daysVisible, $subscriptionEnabled, $publicId, $adminGroupId, $begin, $end, $allowConcurrent),
