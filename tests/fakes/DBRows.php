...
class ReservationResourceRow
{
	...
	private function AddRow($resourceId, $levelId)
	{
		$this->rows[] = array(
				...
				ColumnNames::CREDIT_APPLICABILITY => CreditApplicability::SLOT,
		);
	}
}
...
class ReservationAccessoryRow
{
	...
	public function WithAccessory($accessoryId, $quantityReserved, $name = null, $quantityAvailable = 0, $resourceCount = 0, $creditCount = 0,
								  $peakCreditCount = 0, $creditApplicability = 1)
	{
		$this->rows[] = array(
