...
class ManageResourcesActions
{
	...
	const ActionChangeLabel = 'changeLabel';
}
...
class ManageResourcesPresenter extends ActionPresenter
{
			...
			IUserPreferenceRepository $userPreferenceRepository)
	{
		...
		$this->AddAction(ManageResourcesActions::ActionChangeLabel, 'ChangeLabel');
	}
	...
	{
		$label = $this->page->GetValue();
		Log::Debug("Changing resource reservation label to %s", $label);
		$resource = $this->resourceRepository->LoadById($this->page->GetResourceId());
