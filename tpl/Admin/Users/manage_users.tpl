			...
			<div class="modal-content">
				...
				<div class="col s12 m6">
					<div class="input-field">
						<label for="addUsername" class="active">{translate key="Username"} *</label>
				...
				<div class="col s12 m6">
					<div class="input-field">
						<label for="addEmail" class="active">{translate key="Email"} *</label>
				...
				<div class="col s12 m6">
					<div class="input-field">
						<label for="addFname" class="active">{translate key="FirstName"} *</label>
						<input type="text" {formname key="FIRST_NAME"} class="required"
							   required
							   id="addFname"/>
					</div>
				</div>
				<div class="col s12 m6">
					<div class="input-field">
						<label for="addLname" class="active">{translate key="LastName"} *</label>
				...
				<div class="col s12 m6">
					<div class="input-field">
						<label for="addPassword" class="active">{translate key="Password"} *</label>
						<input type="text" {formname key="PASSWORD"} class="required" required
							   id="addPassword"/>
					</div>
				</div>
				<div class="col s12 m6">
					<div class="input-field">
						<label for="addTimezone" class="active">{translate key="Timezone"}</label>
						<select id="addTimezone" {formname key='TIMEZONE'} class="">
				...
				<div class="col s12 m6">
					<div class="input-field">
						<label for="addPhone" class="active">{translate key="Phone"}</label>
						<input type="text" {formname key="PHONE"} class="" id="addPhone"/>
					</div>
				</div>
				<div class="col s12 m6">
					<div class="input-field">
						<label for="addOrganization" class="active">{translate key="Organization"}</label>
				...
				<div class="col s12 m6">
					<div class="input-field">
						<label for="addPosition" class="active">{translate key="Position"}</label>
						<input type="text" {formname key="POSITION"} class="" id="addPosition"/>
					</div>
				</div>
				<div class="col s12 m6">
					<div class="input-field">
						<label for="addGroup" class="active">{translate key="Group"}</label>
						<select id="addGroup" {formname key='GROUP_ID'} class="">
