...
<div class="modal fade" id="bulkUpdateDialog" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
	 aria-hidden="true">
...
<div class="modal-header">
	...
	<h4 class="modal-title" id="myModalLabel">{translate key=Resources}</h4>
</div>
