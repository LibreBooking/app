		...
		<div class="panel-body">
			<form id="filterForm" class="form-inline" role="form">
				<div class="form-group filter-dates">
					...
					<input id="startDate" type="text" class="form-control dateinput" value="{formatdate date=$StartDate}" size="10"/>
					<input id="formattedStartDate" type="hidden" value="{formatdate date=$StartDate key=system}"/>
					-
					<input id="endDate" type="text" class="form-control dateinput" value="{formatdate date=$EndDate}" size="10" title="End date"/>
				...
				<div class="form-group filter-schedule">
				...
				<div class="form-group filter-resource">
				...
				<div class="form-group filter-referenceNumber">
				...
				<div class="form-group filter-resourceStatus">
				...
				<div class="form-group filter-resourceStatusReason">
