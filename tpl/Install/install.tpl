...
<div id="page-install">
    <h1 class="page-title">{translate key=InstallApplication}</h1>
        ...
        <form class="register" method="post" action="{$smarty.server.SCRIPT_NAME}" role="form">
            ...
            {if $ShowPasswordPrompt}
                <div class="">
                    ...
                    <div class="input-field"><label for="INSTALL_PASSWORD">Install
                            Password</label>{textbox type="password" name="INSTALL_PASSWORD" size="20"}</div>
                    <div>
                    ...
                    {if $ShowInstallOptions}
                        ...
                        <div>
                            <label>
                                ...
                                <span>{translate key=CreateDatabase} ({$dbname})</span>
                            </label>
                            <span style="color:Red;">{translate key=DataWipeWarning}</span>
                        </div>
                        <div>
                            <label>
                                <input type="checkbox" name="create_user"/>
                                <span>{translate key=CreateDatabaseUser} ({$dbuser})</span>
                            </label>
                        </div>
                        <div>
                            <label>
                                <input type="checkbox" name="create_sample_data"/>
                                <span>{translate key=PopulateExampleData}</span>
                            </label>
                        </div>
                        <div>
                            <br/>
