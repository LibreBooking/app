...
<div class="page-my-calendar-month">
	...
	<div class="calendarHeading">
		...
		<div style="float:right;">
			<a href="{PersonalCalendarUrl::Create($Today, CalendarTypes::Day)}" alt="Today"
			   title="Today">{translate key=Today} {html_image src="calendar-day.png"}</a>
			<a href="{PersonalCalendarUrl::Create($Today, CalendarTypes::Week)}" alt="Week"
