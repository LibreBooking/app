	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			var options = {
				...
				dayClickUrl: '{Pages::MY_CALENDAR}?ct={CalendarTypes::Day}&sid={$ScheduleId|escape:'javascript'}&rid={$ResourceId|escape:'javascript'}&gid={$GroupId|escape:'javascript'}',
				dayClickUrlTemplate: '{Pages::MY_CALENDAR}?ct={CalendarTypes::Day}&sid=[sid]&rid=[rid]&gid=[gid]',
