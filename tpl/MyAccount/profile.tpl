...
*}
{include file='globalheader.tpl' Validator=true Select2=true}
...
<div id="page-profile">
			...
			<form method="post" ajaxAction="{ProfileActions::Update}" id="form-profile"
				...
				<div class="row">
					...
					<div class="col s12 m6 input-field">
						...
						<select {formname key='TIMEZONE'} class="browser-default" id="timezoneDropDown">
    ...
    {include file="javascript-includes.tpl" Validator=true Select2=true}
	...
	<script type="text/javascript">
		...
		,
            {FormKeys::EMAIL}:
			{
				required: '{{translate key=ValidEmailRequired}|escape:javascript}', email
			:
