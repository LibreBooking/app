...
<div class="page-search-reservations row" id="page-search-reservations">
    ...
    <form role="form" name="searchForm" id="searchForm" method="post"
        ...
        <div class="col s12 m4">
            ...
            <select id="resources" class="browser-default" multiple="multiple" {formname key=RESOURCE_ID multi=true}>
        ...
        <div class="col s12 m4">
            ...
            <select id="schedules" class="browser-default" multiple="multiple" {formname key=SCHEDULE_ID multi=true}>
