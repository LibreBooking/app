...
<div class="page-search-reservations">
	...
	<form role="form" name="searchForm" id="searchForm" method="post"
		...
		<div class="form-group col-sm-4">
			...
			<input type="search" id="title" class="form-control" {formname key=RESERVATION_TITLE} placeholder="{translate key=Title}" />
		...
		<div class="form-group col-sm-4">
			...
			<input type="search" id="description" class="form-control" {formname key=DESCRIPTION} placeholder="{translate key=Description}" />
		...
		<div class="form-group col-sm-4">
			<div class="btn-group" data-toggle="buttons">
				...
				<label class="btn btn-default active">
					<input type="radio" id="daterange" value="daterange" checked="checked" {formname key=AVAILABILITY_RANGE} />
		...
		<div class="form-group col-sm-4">
				...
				<input type="hidden" id="formattedBeginDate" {formname key=BEGIN_DATE} value="{formatdate date=$BeginDate key=system}"/>
				-
