...
<div id="page-saved-reports" class="page-report">

    <div class="col s12 card" id="saved-reports-panel">
        <div class="card-content">
            <div class="panel-heading">
                <strong>{translate key=MySavedReports}</strong> <span class="badge">{$ReportList|count}</span>
            </div>
                            ...
                            {foreach from=$ReportList item=report}
                                ...
                                <tr reportId="{$report->Id()}" class="{$rowCss}">
                                    ...
                                    <td class="report-action"><a href="#" class="emailNow report"><span
                                                    class="fa fa-envelope-o icon"></span> {translate key=EmailReport}
                                        </a>
                                    </td>
                                    <td class="report-action"><a href="#" class="delete report"><span
                                                    class="fa fa-trash icon remove"></span> {translate key=Delete}</a>
                                    </td>
                                    {*
