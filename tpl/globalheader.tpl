		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav">
				{if $LoggedIn}
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">{translate key="Schedule"} <b class="caret"></b></a>
						<ul class="dropdown-menu">
					...
					{if $CanViewAdmin}
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">{translate key="ApplicationManagement"} <b class="caret"></b></a>
							<ul class="dropdown-menu">
								{*<li class="title">{translate key="ManageReservations"}</li>*}
								<li><a href="{$Path}admin/manage_reservations.php" class="dropdown-toggle" data-toggle="dropdown">{translate key="ManageReservations"}</a></li>
								<li><a href="{$Path}admin/manage_blackouts.php">{translate key="ManageBlackouts"}</a></li>

								</li>
								<li class="divider"></li>
								<li><a href="{$Path}admin/manage_resources.php" class="dropdown-toggle" data-toggle="dropdown">{translate key="ManageResources"}</a></li>
									{*<ul class="dropdown-menu">*}
					...
					{if $CanViewResponsibilities}
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">{translate key="Responsibilities"} <b class="caret"></b></a>
							<ul class="dropdown-menu">
					...
					{if $CanViewReports}
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">{translate key="Reports"} <b class="caret"></b></a>
							<ul class="dropdown-menu">
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">{translate key="Help"} <b class="caret"></b></a>
					<ul class="dropdown-menu">
