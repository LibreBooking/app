					...
					{if $CanViewAdmin}
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="{$Path}admin/manage_blackouts.php">{translate key="ManageBlackouts"}</a>
								</li>

								<li class="divider"></li>
								<li><a href="{$Path}admin/manage_resources.php">{translate key="ManageResources"}</a>
								</li>
								{*<ul class="dropdown-menu">*}
								<li>
								...
								<li class="dropdown-submenu">
									<a href="#" class="dropdown-toggle"
									   data-toggle="dropdown">{translate key="Customization"}</a>
									<ul class="dropdown-menu">
										<li>
											<a href="{$Path}admin/manage_attributes.php">{translate key="Attributes"}</a>
										</li>
										...
										{/if}
										<li><a href="{$Path}admin/manage_theme.php">{translate key="LookAndFeel"}</a>
										</li>
									</ul>
								</li>
