...
{if $HideNavBar == false}
	<nav class="navbar navbar-expand-lg navbar-light bg-light {if $IsDesktop}fixed-top{else}sticky-top{/if}"
		 role="navigation">
		<a class="navbar-brand"
		   href="{$HomeUrl}">{html_image src="$LogoUrl?{$Version}" alt="$Title" class="logo"}</a>
		<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#booked-navigation" aria-controls="navbarSupportedContent"
		...
		<div class="collapse navbar-collapse" id="booked-navigation">
			<ul class="navbar-nav mr-auto">
				{if $LoggedIn}
					...
					<li id="navMyAccountDropdown" class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" id="myAccountDropdownLink" href="#" class="dropdown-toggle" data-toggle="dropdown"
						   aria-haspopup="true" aria-expanded="false">
							{translate key="MyAccount"}
						</a>
						<div class="dropdown-menu" aria-labelledby="navMyAccountDropdownLink">
							<a id="navProfile" class="dropdown-item" href="{$Path}{Pages::PROFILE}">{translate key="Profile"}</a>
							...
							{if $ShowParticipation}
								<a id="navInvitations" class="dropdown-item" href="{$Path}{Pages::PARTICIPATION}">{translate key="OpenInvitations"}</a>
							{/if}
							{if $CreditsEnabled}
								<a id="navUserCredits" class="dropdown-item" href="{$Path}{Pages::CREDITS}">{translate key="Credits"}</a>
							{/if}
						</div>
					</li>
					<li id="navScheduleDropdown" class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" id="navScheduleDropdownLink" href="#" data-toggle="dropdown" aria-haspopup="true"
						   aria-expanded="false">
					...
					{if $CanViewAdmin}
						<li id="navApplicationManagementDropdown" class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" id="navAppManagementDropdownLink" href="#" class="dropdown-toggle"
							   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								{translate key="ApplicationManagement"}
							</a>
							<div class="dropdown-menu" aria-labelledby="navAppManagementDropdownLink">
								<a id="navManageReservations" class="dropdown-item" href="{$Path}admin/manage_reservations.php">
									{translate key="ManageReservations"}
								</a>
								<a id="navManageBlackouts" class="dropdown-item" href="{$Path}admin/manage_blackouts.php">
								...
								<a id="navManageSchedules" class="dropdown-item" href="{$Path}admin/manage_schedules.php">
									{translate key="ManageSchedules"}</a>
								<a id="navManageResources" class="dropdown-item" href="{$Path}admin/manage_resources.php">
									{translate key="ManageResources"}
								</a>
								<a id="navManageAccessories" class="dropdown-item" href="{$Path}admin/manage_accessories.php">
								...
								<a id="navManageAnnouncements" class="dropdown-item" href="{$Path}admin/manage_announcements.php">
									{translate key="ManageAnnouncements"}
								</a>
								<div class="dropdown-divider"></div>
								{if $PaymentsEnabled}
									<a id="navManagePayments" class="dropdown-item" href="{$Path}admin/manage_payments.php">
										{translate key="ManagePayments"}
									</a>
								{/if}
								<a id="navManageAttributes" class="dropdown-item" href="{$Path}admin/manage_attributes.php">
					...
					{if $CanViewResponsibilities}
						<li id="navResponsibilitiesDropdown" class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" id="navResponsibilitiesDropdownLink" href="#" class="dropdown-toggle"
							   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							...
							<div class="dropdown-menu" aria-labelledby="navResponsibilitiesDropdownLink">
								{if $CanViewGroupAdmin}
									<a id="navResponsibilitiesGAUsers" class="dropdown-item" href="{$Path}admin/manage_group_users.php">
										{translate key="ManageUsers"}
									</a>
									<a id="navResponsibilitiesGAReservations" class="dropdown-item" href="{$Path}admin/manage_group_reservations.php">
										{translate key="GroupReservations"}
									</a>
									<a id="navResponsibilitiesGAGroups" class="dropdown-item" href="{$Path}admin/manage_admin_groups.php">
										{translate key="ManageGroups"}
									</a>
								{/if}
								{if $CanViewResourceAdmin || $CanViewScheduleAdmin}
									<a id="navResponsibilitiesRAResources" class="dropdown-item" href="{$Path}admin/manage_admin_resources.php">
										{translate key="ManageResources"}
									</a>
									<a id="navResponsibilitiesRABlackouts" class="dropdown-item" href="{$Path}admin/manage_blackouts.php">
										{translate key="ManageBlackouts"}
									</a>
								{/if}
								{if $CanViewResourceAdmin}
									<a id="navResponsibilitiesRAReservations" class="dropdown-item" href="{$Path}admin/manage_resource_reservations.php">
										{translate key="ResourceReservations"}
									</a>
								{/if}
								{if $CanViewScheduleAdmin}
									<a id="navResponsibilitiesSASchedules" class="dropdown-item" href="{$Path}admin/manage_admin_schedules.php">
										{translate key="ManageSchedules"}
									</a>
									<a id="navResponsibilitiesSAReservations" class="dropdown-item" href="{$Path}admin/manage_schedule_reservations.php">
										{translate key="ScheduleReservations"}
									</a>
								{/if}
								<a id="navResponsibilitiesAnnouncements" class="dropdown-item" href="{$Path}admin/manage_announcements.php">
									{translate key="ManageAnnouncements"}
								</a>
							</div>
						</li>
					...
					{if $CanViewReports}
						<li id="navReportsDropdown" class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" id="navReportsDropdownLink" href="#" class="dropdown-toggle"
							   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								{translate key="Reports"}
							</a>
							<div class="dropdown-menu" aria-labelledby="navReportsDropdownLink">
								<a id="navGenerateReport" class="dropdown-item" href="{$Path}reports/{Pages::REPORTS_GENERATE}">
									{translate key=GenerateReport}
								</a>
								<a id="navSavedReports" class="dropdown-item" href="{$Path}reports/{Pages::REPORTS_SAVED}">
									{translate key=MySavedReports}
								</a>
								<a id="navCommonReports" class="dropdown-item" href="{$Path}reports/{Pages::REPORTS_COMMON}">
			...
			<ul class="navbar-nav text-right">
				{if $ShowScheduleLink}
					<li id="navScheduleDropdown" class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" id="navRightScheduleDropdownLink" href="#" class="dropdown-toggle" data-toggle="dropdown"
						   aria-haspopup="true" aria-expanded="false">
							{translate key="Schedule"}
						</a>
				...
				{if $CanViewAdmin}
					<li id="navAdminDropdown" class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" id="navAdminDropdownLink" href="#" class="dropdown-toggle" data-toggle="dropdown"
						   aria-haspopup="true" aria-expanded="false">
						...
						<div class="dropdown-menu" aria-labelledby="navAdminDropdownLink">
							{if $EnableConfigurationPage}
								<a id="navManageConfiguration" class="dropdown-item" href="{$Path}admin/manage_configuration.php">
									{translate key="ManageConfiguration"}
								</a>
							{/if}
							<a id="navEmailTemplates" class="dropdown-item" href="{$Path}admin/manage_email_templates.php">
							...
							{if $ShowNewVersion}
								<div class="dropdown-divider"></div>
								<a id="navNewVersion" class="dropdown-item" href="https://www.bookedscheduler.com/whatsnew">
				...
				<li id="navHelpDropdown" class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" id="navHelpDropdownLink" href="#" class="dropdown-toggle" data-toggle="dropdown"
					   aria-haspopup="true" aria-expanded="false">
						{translate key="Help"}
					</a>
