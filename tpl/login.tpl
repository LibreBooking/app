...
<div id="page-login">
	...
	<div class="col-md-offset-3 col-md-6 col-xs-10 col-xs-offset-1">
		<div id="login-header" class="default-box-header">
			...
			{if $ShowRegisterLink}<span class="pull-right register">{translate key="FirstTimeUser?"} <a href="{$RegisterUrl}"
		...
		<form role="form" name="login" id="login" class="form-horizontal" method="post"
			...
			<div id="login-footer">
				...
				<div id="forgot-password" class="pull-left">
					<a href="{$ForgotPasswordUrl}" class="btn btn-link"><span><i class="glyphicon glyphicon-question-sign"></i></span> {translate key='ForgotMyPassword'}</a>
				</div>
				{/if}
