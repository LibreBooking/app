...
interface IReportingService
{
	 ...
	 * @return IReport
	 */
	public function GenerateCustomReport(Report_ResultSelection $selection, Report_GroupBy $groupBy, Report_Range $range, Report_Filter $filter);
}
...
class ReportingService implements IReportingService
{
	...
	public function GenerateCustomReport(Report_ResultSelection $selection, Report_GroupBy $groupBy, Report_Range $range, Report_Filter $filter)
	{
		// TODO: Implement GenerateCustomReport() method.
	}
}
